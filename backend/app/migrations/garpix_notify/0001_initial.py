# Generated by Django 3.1 on 2022-06-08 14:47
...
import garpix_notify.utils.call_code_cheker
import garpix_notify.utils.file
import garpix_notify.utils.sms_checker
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(choices=[(0, 'E-mail'), (1, 'SMS'), (2, 'Push'), (3, 'Telegram'), (4, 'Viber'), (5, 'System'), (6, 'Call')], verbose_name='Тип')),
            ...
            bases=(models.Model, garpix_notify.utils.sms_checker.SMSClient, garpix_notify.utils.call_code_cheker.CallClient),
        ),
        migrations.CreateModel(
            name='NotifyCategory',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('call_url_type', models.IntegerField(choices=[(0, 'sms.ru API'), (1, 'sms.ru LOGIN')], default=0, verbose_name='URL звонка провайдера')),
                ('call_api_id', models.CharField(blank=True, default='1234567890', max_length=255, verbose_name='API ID оператора связи')),
                ('call_login', models.CharField(blank=True, default='', max_length=255, verbose_name='Логин пользователя оператора связи')),
                ('call_password', models.CharField(blank=True, default='', max_length=255, verbose_name='Пароль для api СМС провайдера')),
